...
function sendApprovalEmail($emails, $details, $requestData) {
    ...
    $mail->Subject = 'Medical Request Not Approval';
    // Construct email body with additional data
    $mail->Body = 'medical request has not been approved. Details: ' . $details .
...
if ($result_fetch_details->num_rows > 0) {
    ...
    sendApprovalEmail([$student_email], $approval_details, [
    ...
    $sql_update = "UPDATE requesting_medical SET approval_status = 'no' WHERE request_id = $requestID";
